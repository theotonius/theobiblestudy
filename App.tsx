...
import { Music, Search, Heart, User, Sparkles, Loader2, BookOpen, LogOut, ShieldCheck, Facebook, Share2, Check, Bookmark, Trash2, ChevronLeft, ChevronRight, CloudOff, X, Moon, Sun, Coffee, Code2, Github, Globe, Linkedin, Mail, ExternalLink, Cpu, Phone, Smartphone, MessageCircle, Shield } from 'lucide-react';
        ...
        {activeTab === AppTab.Profile ? (
          ...
          <div className="py-10 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className={`p-8 rounded-[2.5rem] border shadow-2xl relative overflow-hidden ${cardBgClasses}`}>
               ...
               <div className="relative z-10">
                  <div className="relative mb-6 flex justify-center">
                    <div className={`w-36 h-36 rounded-[2.5rem] p-1 shadow-2xl border-4 ${theme === Theme.Dark ? 'border-indigo-500/40' : 'border-white'}`}>
                       <img 
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-[10px] font-black text-indigo-500 uppercase tracking-[0.3em]">Fullstack AI Engineer</p>
                  </div>
                  
                  <p className="text-sm leading-relaxed opacity-70 mb-8 font-medium italic text-center px-4">
                  ...
                  <div className="space-y-4">
                     <div className={`p-5 rounded-3xl border flex items-center justify-between group transition-all ${theme === Theme.Dark ? 'bg-slate-700/30 border-slate-600' : 'bg-indigo-50/50 border-indigo-100 shadow-sm'}`}>
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                             <h3 className="text-[10px] font-black uppercase tracking-widest opacity-40 mb-0.5">Mobile Contact</h3>
                             <p className="text-sm font-bold tracking-tight text-indigo-500">+8801614802711</p>
                          </div>
                        </div>
                     ...
                     <div className="pt-2">
                        <h3 className="text-[10px] font-black uppercase tracking-widest opacity-40 mb-4 text-center">Social Connectivity</h3>
                        <div className="grid grid-cols-4 gap-4 px-4">
                           <button className={`p-4 rounded-2xl border flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg ${cardBgClasses}`}><Github className="w-5 h-5" /></button>
                           <button className={`p-4 rounded-2xl border flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg ${cardBgClasses}`}><Globe className="w-5 h-5 text-blue-500" /></button>
                           <button className={`p-4 rounded-2xl border flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg ${cardBgClasses}`}><Linkedin className="w-5 h-5 text-indigo-600" /></button>
                           <button className={`p-4 rounded-2xl border flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg ${cardBgClasses}`}><Mail className="w-5 h-5 text-rose-500" /></button>
                        </div>
                     </div>

                     <button className="w-full bg-amber-500 text-white py-5 rounded-3xl font-black text-sm uppercase tracking-[0.2em] flex items-center justify-center gap-3 shadow-2xl shadow-amber-500/30 mt-6 hover:translate-y-[-2px] active:translate-y-0 transition-all">
                        <Coffee className="w-6 h-6" /> Support My Work
                     </button>
                  </div>
               </div>
            </div>
            ...
            <div className="mt-8 text-center opacity-40">
               <p className="text-[10px] font-bold uppercase tracking-widest">Version 2.5.0 • Sacred Melodies Build</p>
            </div>
          </div>
